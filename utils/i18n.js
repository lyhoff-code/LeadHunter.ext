...
export const translations = {
  en: {
    ...
    statusActive: 'Hunting',
    statusPaused: 'Resting',
    ...
    // Dashboard
    leadsToday: "Today's Catch",
    leadsTotal: 'Total Prey',
    hotLeads: 'Trophies',
    scanned: 'Tracked',
    byUrgency: 'Hunt Priority',
    urgencyCritical: 'Strike Now',
    urgencyHigh: 'Hot Trail',
    urgencyMedium: 'Tracking',
    urgencyLow: 'Scouting',
    recentLeads: 'Fresh Tracks',
    noLeadsYet: 'No prey spotted yet. Scout the hunting grounds!',
    pauseScanning: 'Rest',
    resumeScanning: 'Hunt',
    exportCsv: 'Export Trophies',
  ...
  es: {
    // Header
    appName: 'Lead Hunter AI',
    statusActive: 'Cazando',
    statusPaused: 'Descansando',

    // Tabs
    tabDashboard: 'Cacería',
    tabLeads: 'Presas',
    tabSettings: 'Equipo',

    // Dashboard
    leadsToday: 'Capturados Hoy',
    leadsTotal: 'Total Presas',
    hotLeads: 'Trofeos',
    scanned: 'Rastreados',
    byUrgency: 'Prioridad de Caza',
    urgencyCritical: '¡Atacar Ya!',
    urgencyHigh: 'Rastro Caliente',
    urgencyMedium: 'Rastreando',
    urgencyLow: 'Explorando',
    recentLeads: 'Rastros Frescos',
    noLeadsYet: 'No hay presas detectadas. ¡Explora los territorios de caza!',
    pauseScanning: 'Descansar',
    resumeScanning: 'Cazar',
    exportCsv: 'Exportar Trofeos',
